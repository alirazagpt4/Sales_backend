import { generateDailyVisitReport, generateSummaryReport, generateMyReport, generateMeterReadingReport, generateVisitVerificationReport, getVisitCountReport, generateSalesPersonWiseDvrReport } from '../controllers/report.controller.js';
...
router.get('/reports/sales-person-wise-dvr-report', authenticateToken, generateSalesPersonWiseDvrReport);
